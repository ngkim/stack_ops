...
"""
urc_agent 모듈에서 사용되는 유틸러티 라이브러리 모음
"""
...
def check_process(process_name, mypid=0):
    # process_name 관련 프로세스가 있으면, 1 이상 없으면 0
...
def check_process_by_port(port):        
    """
    주어진 포트를 사용하는 프로세스가 있으면, 1 이상 없으면 0
    """
...
if __name__ == '__main__':
    ...
    print "\n# python environment info print test"
    print EnvInfo()
    
    print "\n# python process info print test"
    print ProcessInfo()             
    
    print "\n# python thread info print test"
    print ThreadInfo()   
    
    print "\n# python stack show test"
    show_stack()
    
    print "\n# python str2raw 변환 test"
    print str2raw("\str'2'raw") # -> \str\'2\'raw
    
    print "\n# python_object_size_enumerate print test"
    ret=python_object_size_enumerate()    
    
    print "\n# check_process test"
    ret=check_process('python')
    print "%s process num %d" % ('python', ret)
    
    print "\n# check_process_by_port test"
    ret=check_process_by_port('3306')
    print "%s process num %d" % ('3306', ret)   
